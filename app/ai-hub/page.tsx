...
import { Compass, ArrowLeft, ShieldCheck, Cpu, Code2 } from "lucide-react";
              ...
              <div className="relative z-10 flex flex-col-reverse lg:grid lg:grid-cols-12 gap-0">
                ...
                <div className="lg:col-span-7 p-8 lg:p-14 flex flex-col justify-center relative">
                  ...
                  <p className="text-gray-500 text-lg leading-8 max-w-lg font-medium mb-8">
                    دستیار هوشمند ما در کنار شماست تا کدهای تمیزتر بنویسید،
                    باگ‌ها را در لحظه شکار کنید و از فرایند خلق نرم‌افزار لذت
                    ببرید.
                  </p>
                  ...
                  >
                    <defs>
                      ...
                      >
                        ...
                        <stop
                          offset="0%"
                          className="stop-action-300"
                          stopOpacity="0.4"
                          style={{
                            stopColor: "var(--color-action-300, #86efac)",
                          }}
                        />
                        <stop
                          offset="100%"
                          className="stop-action-600"
                          style={{
                            stopColor: "var(--color-action-600, #16a34a)",
                          }}
                        />
                      </linearGradient>
                      <filter
                ...
                <div className="flex-1 p-8 lg:p-12 flex flex-col justify-center items-center md:items-start text-center md:text-right relative z-10">
                  <div className="space-y-4 mb-8 w-full">
                    ...
                    <p className="text-gray-500 font-medium text-lg leading-relaxed max-w-lg">
                      بر اساس مهارت‌های فعلی خود، یک نقشه راه دقیق دریافت کنید و
                      با تمرین‌های عملی، برای استخدام آماده شوید.
                    </p>
                  </div>
